...
class DPGMM:
    ...
    def __init__(self, components, min_component_weight, x, x_sep, x_weight, random_number, max_iterations = 500, tolerance = 1e-3):
    ...
    def __initialize_wishart_prior_psi(self):
        ...
        self.__wishart_prior_psi[ : self.__x_sep , self.__x_sep : ] = 0.0
        self.__wishart_prior_psi[ self.__x_sep : , : self.__x_sep ] = 0.0
    ...
    def __update_wishart_psi(self):
        ...
        for component in range(self.__components):
            ...
            self.__wishart_psi[component][ : self.__x_sep , self.__x_sep : ] = 0.0
            self.__wishart_psi[component][ self.__x_sep : , : self.__x_sep ] = 0.0
    ...
    def __update_component_sigma(self):
        ...
        for component in range(self.__components):
            ...
            self.__component_sigma[component][ : self.__x_sep , self.__x_sep : ] = 0.0
            self.__component_sigma[component][ self.__x_sep : , : self.__x_sep ] = 0.0
