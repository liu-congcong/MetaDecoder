...
# Download and install MetaDecoder version 1.0.8 #
pip3 install https://github.com/liu-congcong/MetaDecoder/releases/download/v1.0.8/metadecoder-1.0.8-py3-none-any.whl
```
